...
function Header({ onClear }) {
  return <header className="topbar"><Logo /><div className="topbar-center"><span className="live-dot" /> <span>WORKSPACE / GOA 2026</span><span className="slash">/</span><span className="muted">TASK 02</span></div><div className="topbar-actions"><div className="status-pill"><span className="pulse-dot" /> PIPELINE READY</div><button className="icon-button" aria-label="Help" onClick={() => notify("Voice RAG help center is coming soon.")}><HelpCircle size={17} /></button><button className="avatar" aria-label="Profile">A</button></div></header>;
}
