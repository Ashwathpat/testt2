...
export default function App() {
  ...
  const openWorkspace = () => { window.scrollTo({ top: 0, behavior: "auto" }); setView("workspace"); };
  const returnToLanding = () => { window.scrollTo({ top: 0, behavior: "auto" }); setView("landing"); };
